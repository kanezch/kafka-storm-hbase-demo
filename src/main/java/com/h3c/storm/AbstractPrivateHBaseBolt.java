...
public abstract class AbstractPrivateHBaseBolt extends BaseRichBolt
{
	private static final Logger		LOG	= LoggerFactory.getLogger(AbstractPrivateHBaseBolt.class);
	...
	public AbstractPrivateHBaseBolt(String tableName, HBaseMapper mapper)
	{
	...
	public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector)
	{
		...
		// heck for backward compatibility, we need to pass
		// TOPOLOGY_AUTO_CREDENTIALS to hbase conf
